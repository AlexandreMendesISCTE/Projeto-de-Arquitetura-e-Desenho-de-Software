...
export interface N8NResponse {
  message: string
  action?: 'set_origin' | 'set_destination' | 'add_waypoint' | 'clear_route' | 'set_route' | null
  location?: {
    name: string
    lat: number
    lng: number
 ...
 * @returns Promise<N8NResponse> - Resposta completa do n8n incluindo ações e localizações
